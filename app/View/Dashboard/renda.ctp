    ...
    <div class="card-body">
        ...
        <?php echo $this->Form->create('report'); ?>
            <div class="row" style="padding-bottom: 7px;">
                ...
                <div class="col-md-3">
                    <?php echo $this->Form->input('etnia_id',array('label' => 'Etnias', 'class' => 'form-control form-control-chosen','options'=>$etnias,"empty"=>"Todas etnias","label"=>false)); ?>
                </div>

                <div class="col-md-3">
                    <?php echo $this->Form->input('genero_id',array('label' => 'Gênero', 'class' => 'form-control form-control-chosen','options'=>$generos,"empty"=>"Todas rendas","label"=>false)); ?>
                </div>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <?php foreach ($dados as $key => $value) { ?>
                                <th><?php echo $value["renda"]["faixa"] ?></th>
                            <?php } ?>
                        </tr>
                        <tr>
                            <td>Total</td>
